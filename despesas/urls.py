...
urlpatterns = [
	...
	path('extras/money-box/novo', views.criar_despesa_money_box, name='novo_money_box'),
	path('extras/money-box/editar/<int:id>/', views.editar_despesa_money_box, name='editar_despesa_money_box'), 
	path('extras/money-box/excluir/<int:id>/', views.excluir_despesa_money_box, name='excluir_despesa_money_box'),
	path('extras/money-box/exportar/', views.exportar_excel_money_box, name='exportar_excel_money_box'),
